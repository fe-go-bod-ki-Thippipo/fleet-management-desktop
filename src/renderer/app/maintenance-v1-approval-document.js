...
(function(){
  ...
  function printSheetHtml(doc){
    ...
    return `<div class="print-sheet apd-sheet"><style>
      ...
      .apd-photos{display:flex;flex-wrap:wrap;gap:10px}.apd-photo-item{width:120px}.apd-photo-item img{width:120px;height:90px;object-fit:cover;border-radius:6px;border:1px solid #ccd8e3;display:block}.apd-photo-item small{display:block;font-size:9.5px;color:#5b6f82;margin-top:3px;overflow-wrap:anywhere}
