...
(function(){
  ...
  function printSheetHtml(doc){
    ...
    <section class="apd-card"><div class="apd-card-head"><span class="apd-icon">🔧</span><span>ข้อเสนอซ่อม</span></div><div class="apd-card-body apd-grid"><div class="apd-field apd-wide"><span class="apd-label">คำอธิบาย</span><span class="apd-value">${esc(r.issue||'-')}</span></div><div class="apd-field"><span class="apd-label">ผู้ให้บริการที่เสนอ</span><span class="apd-value">${esc(p.vendorNameSnapshot||'-')}</span></div><div class="apd-field"><span class="apd-label">ติดต่อ</span><span class="apd-value">${esc(p.vendorContact||'-')}</span></div><div class="apd-field apd-wide"><span class="apd-label">ประมาณการ</span><span class="apd-value"><b>${money(p.estimatedCost)} บาท</b></span></div></div></section>
